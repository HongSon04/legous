...
$totalBill = $newAdminModel->getTotalBillByMonthDone($month, $year);
    ...
    <div class="top">
        ...
        <div class="info-user">
                ...
                <ul class="showFeatureAdminHeader box-shadow1">
                    ...
                    ?>
                        ...
                        foreach ($getCmt as $item) {
                            ...
                            $getUser = $newUserModel->getUserById($item['id_user']);
                            $getProduct = $newProductModel->getProductById($item['id_product']);
                        ?>
                            <li>
                                <div class="col-12 d-flex">
                                    <div class="col-2">
                                        ...
                                        ?>
                                            <img class="notifiAdminImg" src="./public/upload/users/profile.jpg" alt="">

                                        <?php
                                        } else {
                                        ?>
                                            <img class="notifiAdminImg" src="./public/upload/users/<?php echo $getUser['img'] ?>" alt="">
                                        <?php
                                        }
                                        ?>
                                    </div>
                            ...
                            <li>
                                <div class="col-12 d-flex">
                                    ...
                                    <div class="col-10">
                                        <p class="notifiAdminText body-small"><strong>
                                                <?php
                                                if ($getUser['fullname'] == NULL && empty($getUser['fullname'])) {
                                                    echo "User ẩn";
                                                } else {
            ...
            <div class="imgUserAdmin">
                ...
                $newUserModel = new User();
                $getUser = $newUserModel->getUserById($getID);
                if (!empty($getUser['img']) || $getUser['img'] != NULL) {
                ?>
                    <img class="btnShowFeature" src="./public/upload/users/<?php echo $getUser['img'] ?>" alt="">
                <?php
                } else {
                ?>
                    <img class="btnShowFeature" src="./public/upload/users/profile.jpg" alt="">
                <?php
                }
                ?>
                <ul class="showFeatureAdminHeader box-shadow1">
                    ...
                    <li><a class="body-small" href="/logout">Đăng Xuất</a></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="owl-carousel owl-theme p30">
            <div class="item box-shadow1 slider_contain">
                <div class="slider_items p-4">
                    <div class="col-12 d-flex">
                        <div class="col-6">
                            <h5 class="label-large">Doanh Thu Theo Tháng</h5>
                        </div>
                    ...
                    <div class="col-12 d-flex justify-content-between align-items-center my-3">
                        <div class="d-flex align-items-center">
                            ...
                            <p class="dashboard-moneyEarn title-medium"><span>
                                    <?php print_r(number_format($totalBill['total'])) ?> VNĐ
                                </span></p>
                        </div>
                    ...
                    <div class="col-12 text-end">
                        <p class="label-medium date-dashboardV">So với tháng 1 - 2024</p>
                    </div>
                </div>
            </div>
            <div class="item box-shadow1 slider_contain slider_contain-2">
                <div class="slider_items p-4">
                    <div class="col-12 d-flex">
                        <div class="col-6">
                            <h5 class="label-large">Sản Phẩm Đã Bán Theo Tháng</h5>
                        </div>
                        <div class="col-6 d-flex justify-content-end align-content-center"><i class="far fa-ellipsis-v"></i></div>
                    </div>
                    <div class="col-12 d-flex justify-content-between align-items-center my-3">
                        <div class="d-flex align-items-center">
                            <button class="buttonWallet"><i class="far fa-wallet" style="color: #ffffff;"></i></button>
                    ...
                    <div class="col-12 text-end">
                        <p class="label-medium">So với tháng 1 - 2024</p>
                    </div>
                </div>
            </div>
            ...
            <div class="statisticalChartItems">
                <div class="col-12 d-xxl-flex customerOrderStatistics d-md-block d-sm-block">
                    <div class="col-xxl-7  col-lg-12 col-md-12 col-sm-12 p20 box-shadow1 orderStatistics me-0 me-xxl-5 me-xl-5 me-lg-5">
                            ...
                            <div class="col-12 col-xxl-6 col-xl-6 col-lg-6 mt-3 mt-xxl-0 mt-xl-0 mt-lg-0">
                                <ul class="nav nav-tabs myNavTabs" id="myTab" role="tablist">
                                    <li class="nav-item myNavItem" role="presentation" style="width: 50%;">
                                        <button style="width: 100%;" class="nav-link active" id="statistical" data-bs-toggle="tab" data-bs-target="#statistical-date" type="button" role="tab" aria-controls="statistical-date" aria-selected="true">Theo
                                            Ngày</button>
                                    </li>
                                    <li class="nav-item myNavItem" role="presentation" style="width: 50%;">
                                        <button style="width: 100%;" class="nav-link" id="statistical" data-bs-toggle="tab" data-bs-target="#statistical-month" type="button" role="tab" aria-controls="statistical-month" aria-selected="false">Theo
                                            Tháng</button>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="col-12">
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="statistical-date" role="tabpanel" aria-labelledby="statistical" tabindex="0">
                                    <div style="width: 100%; height: 350px; margin: 0 auto;">
                                        <canvas id="myChart2"></canvas>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="statistical-month" role="tabpanel" aria-labelledby="statistical" tabindex="0">
                                    <div style="width: 100%; height: 350px; margin: 0 auto;">
                    ...
                    <div class="col-xxl-5 col-lg-12 col-md-12 col-sm-12 p20 box-shadow1 topUsers mt-xxl-0 mt-md-5 mt-sm-5 mt-5">
                        ...
                        <div style="width: 100%; background-color: #49454f36; height: 1.5px; margin: 30px 0;" class="lineAdmin"></div>
                        <div class="bodyTopUser">
                            <div class="topUserOder">
                                <?php
                                $bill = $newBillModel->getBill();
                                $totalByUser = array();
                                ...
                                ?>
                                    ...
                                    foreach ($totalByUser as $userId => $total) {
                                        $newUserModel = new User();
                                        $user = $newUserModel->getUserById($userId);
                                            ...
                                            <div class="col-12 d-flex justify-content-between align-content-center">
                                                <div class="col-6 d-flex ">
                                                    <div class="topUserOrder__image mr6">
                                                        ...
                                                        ?>
                                                            <img src="./public/upload/users/profile.jpg" alt="">
                                                        <?php
                                                        } else {
                                                        ?>
                                                            <img src="./public/upload/users/<?php echo $user['img'] ?>" alt="">
                                                        <?php
                                                        }
                                                        ?>
                                                    </div>
        ...
        <div id="recentOrder" class="recentOrder p30">
            <div class="recentOrder_items p30 box-shadow1">
                ...
                <table>
                    ...
                    $getAllCart = $newCartModel->getNew10Cart();
                    foreach ($getAllCart as $item) {
                        $getAllBill = $newBillModel->getBillByID($item['id_bill']);
                        $getIdUser = $newUserModel->getUserById($getAllBill['id_user']);
                        $getIdProduct = $newProductModel->getProductById($item['id_product']);
                    ?>
                        <tr>
                            ...
                            <td class="label-large">
                                <?php echo $getAllBill['create_date'] ?>
                            </td>
                            <td class="label-large label-large__product" style="width: 350px; max-width: 350px;">
                                <?php echo $getIdProduct['name'] ?>
                            </td>
                            <?php
                            if ($getAllBill['status'] == 6) {
                            ?>
                                <td class="label-large tableLargeItems" style="justify-content: center;"><span class="dotTable red"></span>Đã Hủy</td>
                            <?php
                            } elseif ($getAllBill['status'] == 5) {
                            ?>
                                <td class="label-large tableLargeItems" style="justify-content: center;"><span class="dotTable green"></span>Đã Giao</td>
                            <?php
                            } elseif ($getAllBill['status'] == 4) {
                            ?>
                                <td class="label-large tableLargeItems" style="justify-content: center;"><span class="dotTable orange"></span>Hoàn đơn</td>
                            <?php
                            } elseif ($getAllBill['status'] == 3) {
                            ?>
                                <td class="label-large tableLargeItems" style="justify-content: center;"><span class="dotTable blue"></span>Đang giao hàng</td>
                            <?php
                            } elseif ($getAllBill['status'] == 2) {
                            ?>
                                <td class="label-large tableLargeItems" style="justify-content: center;"><span class="dotTable black"></span>Chờ Lấy Hàng</td>
                            <?php
                            } else {
                            ?>
                                <td class="label-large tableLargeItems" style="justify-content: center;"><span class="dotTable gray"></span>Chờ Xác Nhận</td>
                            <?php
                            }
                            ?>
                            <td class="label-large">
                        ...
                        <div class="topProductSeller_item">
                            ...
                            <div class="ordertopProduct">
                                <div class="ordertopProduct_items">
                                    <?php
                                    $products = $newProductModel->getProducts();
                                    ...
                                    foreach ($totalByProduct as $productId => $total) {
                                        $product = $newProductModel->getProductById($productId);
                                    ?>
                                            ...
                                            <div class="col-12 d-flex justify-content-between">
                                                <div class="col-6 nameCategories">
                                                    ...
                                                    <p class="label-medium">Danh mục: <span>
                                                            ...
                                                            ?>
                                                            <?= $newCategoryModel->getCategoryById($product['id_category'])['name'] ?>
                                                        </span></p>
                                                </div>
