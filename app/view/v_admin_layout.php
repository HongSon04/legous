...
<body>
                ...
                <a href="#">
                    <div class="logo-name d-flex justify-content-center align-items-center">
                        <div class="logo-image">
                            <img style="width: 20px; height: 20px;" src="./public/images/logo.png" alt="">
                        </div>
    ...
    <div class="navBarMobile">
        <div class="navBarMobile_item">
            ...
            <ul>
                <li><a class="title-large" href="/adminDashboard">Bảng Điều Khiển</a></li>
                <li><a class="title-large" href="/adminProduct">Sản Phẩm</a></li>
                <li><a class="title-large" href="/adminCategories?page=1">Danh Mục</a></li>
                <li><a class="title-large" href="/adminOrder">Đơn Hàng</a></li>
                <li><a class="title-large" href="/adminUser">Khách Hàng</a></li>
                <li><a class="title-large" href="/adminAddress">Địa Chỉ</a></li>
                <li><a class="title-large" href="/adminComment">Bình Luận</a></li>
                <li><a class="title-large" href="/adminBanner">Banner</a></li>
                <li><a class="title-large" href="/adminCoupon">Mã Giảm Giá</a></li>
                <li><a class="title-large" href="/logout">Đăng Xuất</a></li>
            </ul>
        </div>
    </div>
    ...
    <main id="mainAdmin">
        ...
        <nav>
            ...
            <div class="menu-items">
                <ul class="nav-links">
                    <li class="<?= (strpos($view_name, 'home')) ? 'active' : '' ?>"><a href="/adminDashboard">
                    ...
                    <li class="<?= (strpos($view_name, 'categories')) ? 'active' : '' ?>"><a
                            href="/AdminCategories?page=1">
                            <i class="fal fa-clipboard-list-check"></i>
                            <span class="link-name title-small">Danh Mục</span>
                        </a></li>
                    <li class="<?= (strpos($view_name, 'orders')) ? 'active' : '' ?>"><a href="/adminOrder">
                            <i class="fal fa-shopping-bag"></i>
                            <span class="link-name title-small">Đơn Hàng</span>
                        </a></li>
                    <li class="<?= (strpos($view_name, 'client')) ? 'active' : '' ?>"><a href="/adminUser">
                            <i class="fal fa-user"></i>
                            <span class="link-name title-small">Khách Hàng</span>
                        </a></li>
                    <li class="<?= (strpos($view_name, 'address')) ? 'active' : '' ?>"><a href="/adminAddress">
                            <i class="far fa-location"></i>
                            <span class="link-name title-small">Địa chỉ</span>
                        </a></li>
                    <li class="<?= (strpos($view_name, 'comment')) ? 'active' : '' ?>"><a
                            href="/adminComment">
                            <i class="far fa-comments"></i>
                            <span class="link-name title-small">Bình luận</span>
                        </a></li>
                    <li class="<?= (strpos($view_name, 'banner')) ? 'active' : '' ?>"><a href="/adminBanner">
                            <i class="fal fa-images"></i>
                            <span class="link-name title-small">Banner</span>
                        </a></li>
                    <li class="<?= (strpos($view_name, 'coupon')) ? 'active' : '' ?>"><a href="/adminCoupon">
