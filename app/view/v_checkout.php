...
$newShippingModel = new Shipping();
$shippingMethods = $newShippingModel->getShippingMethods();
...
$paymentMethods = $newPaymentModel->getPaymentMethods();
...
if (isset($_SESSION['userLogin']) && is_array($_SESSION['userLogin'])) {
    ...
    $userAddress = $newAddressModel->getDefaultAddressByIdUser($id_user);
...
<form action="/confirmOrder" method="post" class="checkout__form mt80">
        ...
        <div class="auto-grid g20 mt30">
                ...
                <div class="checkout__main--info">
                    <div class="form__group__wrapper flex-column g12 box-shadow1 p20 rounded-8">
                        ...
                        <div class="form__group">
                            ...
                            <input type="text" class="form__input address__input" name="address" value="<?= $addressView ?>">
                            <div class="form__message"></div>
                        </div>
                        <div class="form__group">
                            <div class="form__label label-large fw-smb">Địa chỉ cụ thể <span class="error60">*</span>
                            </div>
                            <input type="text" class="form__input address-detail__input" name="address-detail" value="<?= $addressDetailView ?>">
                            <div class="form__message"></div>
                        </div>
                        <div class="form__group">
            ...
            <div class="block">
                <div class="checkout-summary__detail desktop flex-column g20 p20 rounded-8 box-shadow1">
                    ...
                    <button type="submit" class="rounded-8 primary-btn btn" style="background: black; color: white;"><i class="fal fa-arrow-right" style="color: white"></i> Đặt hàng ngay</button>
                </div>
            </div>
    ...
    <div class="cart__bottom-bar p10 mobile">
        <div class="cart__bottom-bar__inner rounded-8 box-shadow5 p10">
            ...
            <button type="submit" class="btn bar-btn rounded-8 ttu mt12 width-full summary-btn" id="summary-btn1" style="background: black; color: white;">
...
<script>
    function toggleRecipientForm() {
        ...
        if (recipientCheckbox.checked) {
            ...
            xhr.open('GET', './app/library/lb_renderRecipientForm.php', true);
...
<script>
    Validator({
        ...
        submitUrl: './app/library/lb_checkoutHandler.php',
...
<script>
    ...
    function updateSummary(shippingPrice) {
        // Send an AJAX request to update the summary
        $.ajax({
            url: "./app/library/lb_updateSummary.php",
            method: "POST",
            data: {
