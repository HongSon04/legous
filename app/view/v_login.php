<main class="main__login-register">
    <section id="register-section" class="oh por section create-account__section banner-cover flex-center g60" style="background-image: url('./public/images/banners/konoha-from-naruto.jpg')">
        <div class="flex rounded-8 oh" style="background: white;">
            <form action="/registerInfo" method="post" id="register__form" class="form register__form flex-column g20 col-2" style="min-width: 33rem">
                ...
                <div class="label-large">Bạn đã có tài khoản? <a href="#login-section" class="click">Đăng nhập ngay!</a>
                </div>
            </form>
            <div class="banner-cover login__banner desktop flex-full col-2" style="aspect-ratio: 1;z-index: 999;background-image: url('./public/images/banners/konoha-from-naruto.jpg'); min-width: 32rem">
            </div>
        </div>
    </section>

    <!-- login -->
    <section id="login-section" class="oh section flex-center por login__section banner-cover flex g60" style="background-image: url('./public/images/banners/banner-login-2.svg')" ;>
        <div class="banner-cover login__banner flex-full" style="aspect-ratio: 1;max-width: 50rem;z-index: 99;background-image: url('./public/images/banners/image\ 5.svg');">
        </div>
        <form action="/youtobe.com" method="post" id="login__form" class="form flex-column g30">
            <div class="form__title">
            ...
            <div class="label-large">Bạn quên mật khẩu? <a href="#register-section" class="click">Nhấp vào đây!</a>
            </div>
        </form>
    </section>
</main>
...
<script>
    Validator({
        ...
        submitUrl: '/registerInfo',
        redirectUrl: '/registerInfo',

        rules: [
            Validator.isRequired('#username__input'),
            Validator.isUsernameAlreadyExist('#username__input', 'Vui lòng điền tên đăng nhập', './app/library/lb_usernameValidator.php'),
            Validator.isRequired('.email--input', 'Vui lòng nhập email của bạn.'),
            Validator.isEmail('.email--input'),
            Validator.isEmailAlreadyExist('.email--input', 'Email này đã tồn tại trên hệ thống', './app/library/lb_emailValidator.php'),
