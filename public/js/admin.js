...
if (document.getElementById("myChart3")) {
  ...
  // Set up an interval to update the chart with new random data every 10 seconds
  setInterval(function () {
    data3.datasets[0].data = [generateRandomData(), generateRandomData()];
    myChart3.update(); // Update the chart with new data
  }, 30000);
}
