!(function (t) {
  ...
  function v(e, n, r, o) {
    ...
    if (n)
      for (i = n.length - 1; 0 <= i; i--) {
        ...
        for (Array.isArray(p) || (p = [p]), l = 0, s = p.length; l < s; l++)
  ...
  function w(e) {
    ...
    if (
      ...
      var r = function (t, e, n) {
        var o, i;
        if ("" !== n)
          for (var l = 0, s = (i = C(n)).length; l < s; l++) {
            if (((n = i[l].match(fe)), (o = i[l].match(de)), n)) {
              if (
                ((i[l] = i[l].replace(fe, "")),
                "" !== i[l] && (t = t[i[l]]),
                (o = []),
                ...
                for (l = 0, s = t.length; l < s; l++) o.push(r(t[l], e, i));
              t =
                "" === (t = n[0].substring(1, n[0].length - 1)) ? o : o.join(t);
              break;
            }
            if (o) (i[l] = i[l].replace(de, "")), (t = t[i[l]]());
            else {
              if (null === t || t[i[l]] === a) return a;
              t = t[i[l]];
            }
          }
        return t;
  ...
  function x(e) {
    ...
    if (
      ...
      var n = function (t, e, r) {
        var o;
        o = (r = C(r))[r.length - 1];
        for (var i, l, s = 0, u = r.length - 1; s < u; s++) {
          if ("__proto__" === r[s] || "constructor" === r[s])
            throw Error("Cannot set prototype values");
          if (((i = r[s].match(fe)), (l = r[s].match(de)), i)) {
            if (
              ((r[s] = r[s].replace(fe, "")),
              (t[r[s]] = []),
              (o = r.slice()).splice(0, s + 1),
              (i = o.join(".")),
              Array.isArray(e))
            )
              for (l = 0, u = e.length; l < u; l++)
                n((o = {}), e[l], i), t[r[s]].push(o);
            else t[r[s]] = e;
            return;
          }
          l && ((r[s] = r[s].replace(de, "")), (t = t[r[s]](e))),
            (null !== t[r[s]] && t[r[s]] !== a) || (t[r[s]] = {}),
            (t = t[r[s]]);
        }
        o.match(de) ? t[o.replace(de, "")](e) : (t[o.replace(fe, "")] = e);
      };
      return function (t, a) {
        return n(t, a, e);
      };
    ...
    var o,
      ...
      h =
        ...
        function (t, e) {
          if ("string" == typeof t) {
            var n = t.indexOf("@");
            -1 !== n && ((n = t.substring(n + 1)), x(t)(r, e.getAttribute(n)));
          }
        }),
      p = function (t) {
        (n !== a && n !== c) ||
          ...
          i && i._bAttrSrc
            ? (x(i.mData._)(r, l),
              ...
              h(i.mData.filter, t))
            : d
            ? (i._setter || (i._setter = x(i.mData)), i._setter(r, l))
            : (r[c] = l)),
          c++;
      };
    if (u)
      for (; u; )
        ("TD" != (o = u.nodeName.toUpperCase()) && "TH" != o) ||
          (p(u), s.push(u)),
          (u = u.nextSibling);
    else for (u = 0, o = (s = e.anCells).length; u < o; u++) p(s[u]);
    return (
  ...
  function P(e, a, r, o) {
    ...
    if (null === f.nTr) {
      for (
        ...
        (l = e.aoColumns[s]),
          ((f = (c = !r) ? n.createElement(l.sCellType) : o[s])._DT_CellIndex =
            { row: a, column: s }),
          h.push(f),
          (!c &&
            ((!l.mRender && l.mData === s) ||
              (t.isPlainObject(l.mData) && l.mData._ === s + ".display"))) ||
            (f.innerHTML = _(e, a, s, "display")),
          l.sClass && (f.className += " " + l.sClass),
          l.bVisible && !r
            ? i.appendChild(f)
            : !l.bVisible && r && f.parentNode.removeChild(f),
          l.fnCreatedCell &&
            l.fnCreatedCell.call(e.oInstance, f, _(e, a, s), d, a, s);
  ...
  function H(e) {
    ...
    if (
      ...
      for (n = 0, a = (e = e.aoFooter[0]).length; n < a; n++)
        ((i = f[n]).nTf = e[n].cell), i.sClass && t(i.nTf).addClass(i.sClass);
  }
  function N(e, n, r) {
    var o,
      i,
    ...
    if (-1 !== t.inArray(!1, n)) ft(e, !1);
      ...
      if (0 !== c.length)
        for (l = u ? e.aoData.length : f, u = u ? 0 : s; u < l; u++) {
          ...
          Nt(e, "aoRowCallback", null, [p, h._aData, r, u, d]), n.push(p), r++;
        }
      else
        (r = l.sZeroRecords),
          1 == e.iDraw && "ajax" == Mt(e)
    ...
    var a = e.oClasses,
      ...
      f =
        ...
        t("input", a)
          ...
          .on("keyup.DT search.DT input.DT paste.DT cut.DT", l ? me(c, l) : c)
          .on("mouseup", function () {
            setTimeout(function () {
              c.call(f[0]);
            }, 10);
      ...
      if (!(s = t.aoData[n])._aFilterData) {
        for (i = [], a = 0, o = u.length; a < o; a++)
          (e = u[a]).bSearchable
            ...
            l.indexOf &&
              -1 !== l.indexOf("&") &&
              ((pe.innerHTML = l), (l = ge ? pe.textContent : pe.innerText)),
  ...
  function dt(e) {
    ...
    return (
      ...
      t(o).css("max-height", r),
      n.bCollapse || t(o).css("height", r),
      (e.nScrollHead = d),
      (e.nScrollBody = o),
      (e.nScrollFoot = h),
      ...
      e.scrollBarVis !== r && e.scrollBarVis !== a
        ...
        : ((e.scrollBarVis = r),
          ...
          "" === s
            ? ((x.width = "100%"),
              F &&
                (C.find("tbody").height() > S.offsetHeight ||
          ...
          (D.width = vt(n)),
          (g.width = vt(n)),
          A && (e.nScrollFoot.style.width = vt(n)),
          !c && F && (D.height = vt(w.offsetHeight + f)),
          (s = C.outerWidth()),
          (m[0].style.width = vt(s)),
          (b.width = vt(s)),
          (u = C.height() > S.clientHeight || "scroll" == v.css("overflow-y")),
          (b[(c = "padding" + (I.bScrollbarLeft ? "Left" : "Right"))] = u
            ? f + "px"
            : "0px"),
          A &&
  ...
  function gt(n) {
    ...
    for (
      ...
      null !== (r = i[f[a]]).sWidth &&
        ((r.sWidth = bt(r.sWidthOrig, S)), (v = !0));
    if (y || (!v && !s && !l && c == b(n) && c == d.length))
      ...
      if (n.aoData.length)
        for (a = 0; a < f.length; a++)
          (r = i[(v = f[a])]),
            t(mt(n, v)).clone(!1).append(r.sContentPadding).appendTo(_);
      for (
        t("[name]", c).removeAttr("name"),
          ...
          s && u
            ...
            ? (c.css("width", "auto"),
              c.removeAttr("width"),
              c.width() < S.clientWidth && g && c.width(S.clientWidth))
            : l
  ...
  function St(t, e) {
    for (var n, a = -1, r = -1, o = 0, i = t.aoData.length; o < i; o++)
      (n = (n = (n = _(t, o, e, "display") + "").replace(be, "")).replace(
        /&nbsp;/g,
        " "
  ...
  function Dt(e) {
    ...
    for (
      o = function (e) {
        e.length && !Array.isArray(e[0]) ? f.push(e) : t.merge(f, e);
      },
        Array.isArray(n) && o(n),
        r && n.pre && o(n.pre),
        o(e.aaSorting),
  ...
  function yt(t) {
    var e,
      ...
      s = 0,
      u = t.aiDisplayMaster;
    for (S(t), e = 0, n = (r = Dt(t)).length; e < n; e++)
        ...
        ? u.sort(function (t, e) {
            ...
            for (i = 0; i < u; i++)
              if (
                0 !==
                (n =
                  (n = c[(s = r[i]).col]) < (a = f[s.col]) ? -1 : n > a ? 1 : 0)
              )
        ...
        : u.sort(function (t, e) {
            ...
            for (s = 0; s < c; s++)
              if (
                ...
                (a = d[u.col]),
                0 !==
                  (n = (u = i[u.type + "-" + u.dir] || i["string-" + u.dir])(
                    n,
                    a
                  )))
              )
        ...
        if (
          ...
          if (
            ...
            for (o = 0, i = n.columns.length; o < i; o++)
              (s = n.columns[o]).visible !== a && (l[o].bVisible = s.visible),
  ...
  function Rt(e, n, r, o) {
    Array.isArray(r)
      ? t.each(r, function (t, a) {
          Array.isArray(a) ? Rt(e, n, a[0], a[1]) : Rt(e, n, a);
        })
  ...
  var Ut,
        ...
        this.each(function () {
          ...
          if ("table" != this.nodeName.toLowerCase())
            ...
            l(S),
              s(S.column),
              o(S, S, !0),
              o(S.column, S.column, !0),
              o(S, t.extend(g, _.data()), !0);
            var T = qt.settings;
            b = 0;
            ...
            (A.nTable = this),
              ...
              (A.oInit = g),
              T.push(A),
              (A.oInstance = 1 === n.length ? n : _.dataTable()),
              l(g),
              i(g.oLanguage),
              g.aLengthMenu &&
                !g.iDisplayLength &&
              ...
              Rt(A.oLanguage, g, "fnInfoCallback"),
              Ht(A, "aoDrawCallback", g.fnDrawCallback, "user"),
              Ht(A, "aoServerParams", g.fnServerParams, "user"),
              Ht(A, "aoStateSaveParams", g.fnStateSaveParams, "user"),
              Ht(A, "aoStateLoadParams", g.fnStateLoadParams, "user"),
              Ht(A, "aoStateLoaded", g.fnStateLoaded, "user"),
              Ht(A, "aoRowCallback", g.fnRowCallback, "user"),
              Ht(A, "aoRowCreatedCallback", g.fnCreatedRow, "user"),
              Ht(A, "aoHeaderCallback", g.fnHeaderCallback, "user"),
              Ht(A, "aoFooterCallback", g.fnFooterCallback, "user"),
              Ht(A, "aoInitComplete", g.fnInitComplete, "user"),
              Ht(A, "aoPreDrawCallback", g.fnPreDrawCallback, "user"),
              (A.rowIdFn = w(g.rowId)),
              u(A);
            var I = A.oClasses;
            t.extend(I, qt.ext.classes, g.oClasses),
              _.addClass(I.sTable),
              A.iInitDisplayStart === a &&
                ((A.iInitDisplayStart = g.iDisplayStart),
                (A._iDisplayStart = g.iDisplayStart)),
              null !== g.iDeferLoading &&
                ((A.bDeferLoading = !0),
                (p = Array.isArray(g.iDeferLoading)),
                (A._iRecordsDisplay = p ? g.iDeferLoading[0] : g.iDeferLoading),
                (A._iRecordsTotal = p ? g.iDeferLoading[1] : g.iDeferLoading));
            var F = A.oLanguage;
            ...
            if (
              (v(A, g.aoColumnDefs, T, function (t, e) {
                d(A, t, e);
              }),
              L.length)
            ) {
            ...
            p = function () {
              if (g.aaSorting === a) {
                ...
                for (b = 0, h = e.length; b < h; b++)
                  e[b][1] = A.aoColumns[b].asSorting[0];
              }
              wt(A),
                P.bSort &&
                ...
                Ht(
                  ...
                  "aoDrawCallback",
                  function () {
                    (A.bSorted || "ssp" === Mt(A) || P.bDeferRender) && wt(A);
                  },
                  "sc"
                );
              ...
              if (
                ...
                0 === n.length || 0 === n.children().length
                  ? _.addClass(I.sNoFooter)
                  : n.length > 0 &&
                    ((A.nTFoot = n[0]), W(A.aoFooter, A.nTFoot)),
                g.aaData)
              )
                for (b = 0; b < g.aaData.length; b++) D(A, g.aaData[b]);
              else
                (A.bDeferLoading || "dom" == Mt(A)) &&
                  y(A, t(A.nTBody).children("tr"));
    ...
    ue = function (t, e) {
      if (Array.isArray(e)) for (var n = 0; n < e.length; n++) ue(t, e[n]);
      else t.push(e);
      return t;
    };
  Array.isArray ||
              ...
              (o = f[s]),
                (o =
                  "cell" === e
                    ...
                    : n.call(g, h[i], o, i, s, c)) !== a && d.push(o);
        }
        return d.length || r
  ...
  Xt("tables()", function (t) {
    return t !== a && null !== t ? new Vt(De(t, this.context)) : this;
  }),
    Xt("table()", function (t) {
  ...
  var _e = function (t, e, n, r, o) {
      ...
      for (
        s = typeof e,
          (e && "string" !== s && "function" !== s && e.length !== a) ||
            (e = [e]),
          s = 0,
          u = e.length;
        s < u;
        ...
        for (
          ...
          (i = n("string" == typeof l[c] ? l[c].trim() : l[c])) &&
            i.length &&
            (d = d.concat(i));
      if ((t = Ut.selector[t]).length)
        for (s = 0, u = t.length; s < u; s++) d = t[s](r, o, d);
      return se(d);
    },
    Te = function (e) {
      return (
  ...
  Xt("rows()", function (e, n) {
      ...
      function (r) {
        ...
        return _e(
          ...
          function (e) {
            ...
            if ((o || (o = we(r, i)), null !== n && -1 !== t.inArray(n, o)))
              return [n];
            ...
            if (e.nodeName) {
              ...
              return n !== a
                ? l[n] && l[n].nTr === e
                  ...
                  : []
                : s
                ? l[s.row] && l[s.row].nTr === e.parentNode
                  ? [s.row]
                  : []
      ...
      var n = this.iterator(
          ...
          function (t) {
            ...
            for (a = 0, r = e.length; a < r; a++)
              (n = e[a]).nodeName && "TR" === n.nodeName.toUpperCase()
                ? o.push(y(t, n)[0])
                : o.push(D(t, n));
            return o;
          },
    ...
    Xt("row().data()", function (t) {
      ...
      return (
        (n._aData = t),
        Array.isArray(t) && n.nTr && n.nTr.id && x(e[0].rowId)(t, n.nTr.id),
        L(e[0], this[0], "data"),
        this
      );
    }),
  ...
  Xt("columns()", function (e, n) {
          ...
          function (e) {
            ...
            if ("function" == typeof e) {
              ...
              return t.map(i, function (t, n) {
                return e(n, Fe(a, n, 0, 0, r), s[n]) ? n : null;
              });
            }
            var u = "string" == typeof e ? e.match(Ie) : "";
            if (u)
              switch (u[2]) {
                case "visIdx":
                case "visible":
        ...
        e !== a &&
          this.iterator("table", function (o) {
            N(o, o.aoHeader),
              N(o, o.aoFooter),
              o.aiDisplay.length ||
                t(o.nTBody).find("td[colspan]").attr("colspan", b(o)),
              At(o),
    ...
    Xt("cells()", function (e, n, r) {
      ...
      (u = this.iterator(
        ...
        (u = r && r.selected ? this.cells(u, r) : u);
      return t.extend(u.selector, { cols: n, rows: e, opts: r }), u;
    }),
    ...
    (qt.defaults = {
      ...
      oLanguage: {
        oAria: {
          sSortAscending: ": Hiển thị cột tăng dần",
          sSortDescending: ": Hiển thị cột giảm dần",
        },
        oPaginate: {
          sFirst: "Trang đầu",
          sLast: "Trang cuối",
        ...
        sInfo: "Hiển thị _START_ tới _END_ trang của tổng  _TOTAL_ mục",
        sInfoEmpty: "Hiển thị 0 tới 0 trang của tổng 0 mục",
          ...
          var u,
            ...
            b = function (n, a) {
              ...
              for (r = 0, i = a.length; r < i; r++)
                if (((m = a[r]), Array.isArray(m)))
                  (f = t("<" + (m.DT_el || "div") + "/>").appendTo(n)), b(f, m);
                else {
                  switch (((u = null), (c = m), (f = e.iTabIndex), m)) {
                    case "ellipsis":
                      n.append('<span class="ellipsis">&#x2026;</span>');
                      break;
                    case "first":
                      (u = h.sFirst), 0 === l && ((f = -1), (c = c + " " + S));
                      break;
                    case "previous":
                      (u = h.sPrevious),
                        0 === l && ((f = -1), (c = c + " " + S));
                    ...
                    case "last":
                      ...
                      break;
                    default:
                      (u = e.fnFormatNumber(m + 1)),
                        (c = l === m ? d.sPageButtonActive : "");
                  }
                  null !== u &&
                    (jt(
                      (f = t("<a>", {
